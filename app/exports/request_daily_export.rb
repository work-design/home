class RequestDailyExport
  ...
  config do
    ...
    column header: '作业班组', field: ->(o) { o.extractions.pluck(:name, :matched).to_h['作业班组'] }
    column header: '工作内容', field: ->(o) { o.extractions.pluck(:name, :matched).to_h['工作内容'] }
    column header: '工作负责人', field: ->(o) { o.extractions.pluck(:name, :matched).to_h['工作负责人'] }
    column header: '计划工作时间', field: ->(o) { o.extractions.pluck(:name, :matched).to_h['计划工作时间'] }
