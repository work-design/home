...
* [减少重复工作造成的浪费]()
* [全链条]()
* [约定优于配置](技术体系/default.md)
* [工具优于约定](技术体系/tools.md)
* [前后端“分离”](技术体系/全栈方案.md)

#### 原理

* [降低数字化成本，实现技术普惠](技术体系/why_build_self.md)
* [工具](技术体系/tools.md)：优化工具，提升生产力，除了通用的功能及组件，我们也对一些工具进行了优化，比如表单构建工具。
* [模块化](技术体系/模块化开发.md)：我们将通用的功能进行了抽取，以 Rails Engine 的形式附加到主项目即可快速应用某块功能；
* [体系化]()：基于统一的设计理念，UI体系，一致性。
* [语言是生产力](技术体系/函数式和面向对象.md)
